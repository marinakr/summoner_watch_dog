...
config :summoner_watch_dog, SummonerWatchDogWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: SummonerWatchDogWeb.ErrorHTML, json: SummonerWatchDogWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: SummonerWatchDog.PubSub,
  live_view: [signing_salt: "mgDwj2/u"]
...
config :summoner_watch_dog, SummonerWatchDog.Mailer, adapter: Swoosh.Adapters.Local
